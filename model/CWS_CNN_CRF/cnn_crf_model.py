...
sents = open('../../data/trainset/train_cws.txt').read()
sents = sents.split('\n')
...
train_sents = sents[:-500] # 留下5000个句子做验证，剩下的都用来训练
valid_sents = sents[-500:]


# print(train_sents)
# print('上面是train_sents')
# print(len(sents))
# print(type(sents))
# # print(sents)
# print(len(sents))
...
from model.CWS_CNN_CRF.crf_model import CRF
...
model.save('cnn_crf_cws_model_2.h5')
print('saved to')

# from keras.models import load_model
# model = load_model('./cnn_crf_cws_model.h5',custom_objects={'CRF': CRF})
# predict = model.predict_classes(['我','是','医','生'])

# test = ['我','是','学','生']
# test_id = []
# for c in test:
#     test_id.append(char2id.get(c, 0))
# print(test_id)
# predict = model.predict (test_id)
# print(predict)
...
result_file = '../../data/testset1/test_cws1_cnn_crf_2.txt'
